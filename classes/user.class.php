...
class User
{
    ...
    {
        $RQ = new ReadQuery("SELECT * FROM bookings WHERE (studentuserid = :id OR staffuserid = :id) AND deleted = 0 AND start_time > NOW()", array(
    ...
    public static function addedit($UID)
    {
    ...
    public static function checkuserlevel($UID)
    {
        if ($UID > 0) {
            $RQ = new ReadQuery(
                "SELECT userlevel FROM users WHERE id = :id",
                array(
                PDOConnection::sqlarray(":id", $UID, PDO::PARAM_INT)
            )
            );
     ...
     */
    public static function getstaticusername($ID)
    {
     ...
     */
    public static function getstaticemail($ID)
    {
     ...
     */
    public static function checkusernameandemail($Username, $Email, $ID = 0)
    {
        if ($Username != "" && $Email != "") {
    ...
    public static function forgotpasswordform($Email = "")
    {
     ...
     */
    public static function signupform($Email = "", $Username = "", $Password = "", $Fullname = "", $Phone = "", $Bio = "", $Department = 0, $Location = "")
    {
        $Departments = array();
...
<?php
     ...
     * @param int $ID - ID of the User
     */
    public static function aboutmepage($ID)
    {
...
<?php
     ...
     */
    public static function signinform($Username = "", $Password="")
    {
    ...
    public static function getlatestbooking($UID)
    {
     ...
     */
    public static function getuserleveltype($userlevel)
    {
        switch ($userlevel) {
            case 1:
                return "Student";
    ...
    public static function getuserlevelarray()
    {
     ...
     * @param string $location - Where the New User is based - only for staff
     */
    public static function edituserform($UID, $fullname, $username, $email, $level, $phone, $photo, $department, $bio, $location)
    {
